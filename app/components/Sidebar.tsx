...
const iconMap: Record<string, React.ElementType> = {
  ...
  "العملاء":               Users,
  "الحالات":               ListChecks,
  "الاجراءات والمتابعه":              ClipboardList,
  "التحصيل":               Wallet,
  "البحث":                 Search,
...
export default function Sidebar({
  ...
  const menu = [
    ...
    ...(role !== "viewer" ? [{ name: "الاجراءات والمتابعه", href: "/actions" }] : []),
    ...
    ...(role !== "super_admin" ? [{ name: "الميزانية ", href: "/monthly-budget" }] : []),
