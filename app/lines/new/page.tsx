    ...
    <div className="max-w-5xl mx-auto p-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <input
          ...
          onChange={(e) =>
            update("account_no", e.target.value)
          }
          className="border p-3 rounded"
        />
        ...
        <input
          ...
          onChange={(e) =>
            update("customer_date", e.target.value)
          }
          className="border p-3 rounded"
        />
        ...
        <input
          ...
          onChange={(e) =>
            update("almanafiz", e.target.value)
          }
          className="border p-3 rounded"
        />
        ...
        <input
          ...
          onChange={(e) =>
            update("provider_name", e.target.value)
          }
          className="border p-3 rounded"
        />
        ...
        <input
          ...
          onChange={(e) =>
            update("calls_package", e.target.value)
          }
          className="border p-3 rounded"
        />
        ...
        <input
          ...
          onChange={(e) =>
            update("agent_name", e.target.value)
          }
          className="border p-3 rounded"
        />
        ...
        <input
          ...
          onChange={(e) =>
            update("total_price", e.target.value)
          }
          className="border p-3 rounded"
        />
      ...
      <textarea
        ...
        onChange={(e) =>
          update("report_note", e.target.value)
        }
        className="border p-3 rounded w-full mt-4"
        rows={4}
      />
